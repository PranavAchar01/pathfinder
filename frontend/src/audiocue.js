// Directional audio "buzz" for iPhone, where the browser can't vibrate (WebKit has no
// Vibration API). Encodes the SAME belt packet as sound — stereo pan = direction (L/C/R),
// pitch + loudness = closeness, pulse count = zone (L=1, C=2, R=3), curb = 2 hard tones.
// Web Audio IS supported on iOS Safari. Self-contained: no models, no WebGPU.

let actx = null;

// Must be called inside a user gesture (the START tap) — iOS starts AudioContext suspended.
